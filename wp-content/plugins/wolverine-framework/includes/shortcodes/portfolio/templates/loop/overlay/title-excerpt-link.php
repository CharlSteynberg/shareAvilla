        ...
        <div class="entry-hover-wrapper">
            <div class="entry-hover-inner line-height-1">
                ...
                <?php if ($disable_link == '1'){?>
                    <h5 class="primary-color-hover line-height-1"><?php the_title() ?></h5>
                <?php } else{?>
                    <a href="<?php echo esc_url($link) ?>" class="title"><h5 class="primary-color-hover line-height-1"><?php the_title() ?></h5></a>
                <?php }?>
