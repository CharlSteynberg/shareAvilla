				...
				case "icon":
					...
					<div style="margin: 13px 0">
						...
						<div>
							...
							<input style="float: right"  title="<?php echo __('Click to browse icon','wolverine') ?>" class="browse-icon button-secondary" type="button" value="<?php echo __('Browse...','wolverine') ?>" />
				...
				case "image":
					...
					<div style="margin: 13px 0">
						...
						<div class="widget-image-field">
							...
							<button style="float: right" title="<?php echo __('Click to browse image','wolverine') ?>" class="browse-images button-secondary" type="button"><?php echo __('Browse...','wolverine') ?></button>
						</div>
