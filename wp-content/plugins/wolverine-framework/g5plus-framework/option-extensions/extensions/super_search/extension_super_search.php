        ...
        */
        public function __construct( $parent ) {
            ...
            if ( empty( $this->extension_dir ) ) {
                $this->extension_dir = trailingslashit( str_replace( '\\', '/', PLUGIN_G5PLUS_FRAMEWORK_DIR . 'g5plus-framework/option-extensions/extensions/super_search/' ) );
            }
        ...
        public function overload_field_path($field) {
            return PLUGIN_G5PLUS_FRAMEWORK_DIR .'g5plus-framework/option-extensions/extensions/super_search/'.$this->field_name.'/field_'.$this->field_name.'.php';
        }
