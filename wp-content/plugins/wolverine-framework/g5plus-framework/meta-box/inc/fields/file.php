...
class RWMB_File_Field extends RWMB_Field {
	...
	public static function admin_enqueue_scripts() {
		...
		self::localize_script( 'rwmb-file', 'rwmbFile', array(
			...
			'maxFileUploadsSingle' => __( 'You may only upload maximum %d file', 'wolverine' ),
			// Translators: %d is the number of files in plural form.
			'maxFileUploadsPlural' => __( 'You may only upload maximum %d files', 'wolverine' ),
		) );
	}
	...
	public static function wp_ajax_delete_file() {
		...
		wp_send_json_error( __( 'Error: Cannot delete file', 'wolverine' ) );
	}
	...
	public static function html( $meta, $field ) {
		...
		$i18n_more  = apply_filters( 'rwmb_file_add_string', _x( '+ Add new file', 'file upload', 'wolverine' ), $field );
	...
	protected static function file_html( $file ) {
		$i18n_delete = apply_filters( 'rwmb_file_delete_string', _x( 'Delete', 'file upload', 'wolverine' ) );
		$i18n_edit   = apply_filters( 'rwmb_file_edit_string', _x( 'Edit', 'file upload', 'wolverine' ) );
