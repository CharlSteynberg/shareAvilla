...
class g5plus_import extends G5_Import {
	...
	function import_revslider($other_data) {
		...
		if ( $handle = opendir( G5PLUS_FRAMEWORK_THEME_DIR . "assets" . DIRECTORY_SEPARATOR . "data-demo". DIRECTORY_SEPARATOR . $demo_site . DIRECTORY_SEPARATOR . "revslider" ) ) {
			...
			while ( false !== ( $entry = readdir( $handle ) ) ) {
				...
				if ( $entry != "." && $entry != ".." ) {
					$rev_import_file = G5PLUS_FRAMEWORK_THEME_DIR . "assets" . DIRECTORY_SEPARATOR . "data-demo" . DIRECTORY_SEPARATOR . $demo_site . DIRECTORY_SEPARATOR . "revslider" . DIRECTORY_SEPARATOR . $entry;
