...
// Fix for the GT3 page builder: http://www.gt3themes.com/wordpress-gt3-page-builder-plugin/
    ...
    if ( ! class_exists( 'ReduxFrameworkInstances' ) ) {
        // Instance Container
        require_once(PLUGIN_G5PLUS_FRAMEWORK_DIR . 'g5plus-framework/options/inc/class.redux_instances.php');
        require_once(PLUGIN_G5PLUS_FRAMEWORK_DIR . 'g5plus-framework/options/inc/lib.redux_instances.php');
    }
...
// Don't duplicate me!
    if ( ! class_exists( 'ReduxFramework' ) ) {
        ...
        // Redux API class  :)
        require_once(PLUGIN_G5PLUS_FRAMEWORK_DIR . 'g5plus-framework/options/inc/class.redux_api.php');

        // General helper functions
        require_once(PLUGIN_G5PLUS_FRAMEWORK_DIR . 'g5plus-framework/options/inc/class.redux_helpers.php');

        // General functions
        require_once(PLUGIN_G5PLUS_FRAMEWORK_DIR . 'g5plus-framework/options/inc/class.redux_functions.php');
        require_once(PLUGIN_G5PLUS_FRAMEWORK_DIR . 'g5plus-framework/options/inc/class.p.php');

        require_once(PLUGIN_G5PLUS_FRAMEWORK_DIR . 'g5plus-framework/options/inc/class.redux_filesystem.php');

        // ThemeCheck checks
        require_once(PLUGIN_G5PLUS_FRAMEWORK_DIR . 'g5plus-framework/options/inc/class.redux_themecheck.php');

        // Welcome
        require_once(PLUGIN_G5PLUS_FRAMEWORK_DIR . 'g5plus-framework/options/inc/welcome/welcome.php');
        ...
        class ReduxFramework {
            ...
            public static function init() {
                $dir = Redux_Helpers::cleanFilePath( PLUGIN_G5PLUS_FRAMEWORK_DIR . 'g5plus-framework/options' );
...
// _register_settings()
            ...
            private function _register_extensions() {
                $path    = PLUGIN_G5PLUS_FRAMEWORK_DIR . 'g5plus-framework/options/inc/extensions/';
...
//                }
            ...
            public function ajax_save() {
                ...
                if ($is_generate_less_to_css) {
                    do_action('redux/generate_less_to_css');
                }
