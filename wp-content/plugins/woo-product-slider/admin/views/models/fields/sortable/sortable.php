 ...
 *
 */
if ( ! class_exists( 'SPWPS_Field_sortable' ) ) {
  class SPWPS_Field_sortable extends SPWPS_Fields {
    ...
    public function render() {
      ...
      foreach ( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="spwps--sortable-item">';

          echo '<div class="spwps--sortable-content">';
          ...
          SPWPS::field( $field, $field_value, $unique_id, 'field/sortable' );

          echo '</div>';

          echo '<div class="spwps--sortable-helper"><i class="fas fa-arrows-alt"></i></div>';
