	...
	public function help_page_callback() {
		...
		<div class="sp-woo-product-slider-help-page">
					...
					<div class="header-area">
						<div class="container">
							<div class="header-logo">
								<img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/woo-product-slider-logo.svg'; ?>" alt="">
								<span><?php echo SP_WPS_VERSION; ?></span>
							</div>
				...
				<section class="sp-wps-help upgrade">
					...
					<img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/wps-icon-color.svg'; ?>" alt="">
					</div>
							...
							<div class="row">
								<div class="col-lg-6">
									<ul class="upgrade-list">
										<li><img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">
										Advanced Shortcode Generator.</li>
										<li><img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">
										2 Unique Layouts (Slider and Grid).</li>
										<li><img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">Multiple Product Sliders and Grids on the same page.</li>
										<li><img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">30+ Professionally Pre-designed Themes/Templates.</li>
										<li><img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">Theme/Template Modification from the theme directory.</li>
										<li><img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt=""> Advanced Typography(fonts, colors, styling).</li>
										<li><img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt=""> Filter the list of products you want to show in the slider or grid: (Categories, Tags, Specific, On Sale!, Best Selling or Popular, Upsells, Cross-sells, Related Products, Top Rated, Most Viewed, Recently Viewed, Free Products, By Product ID or SKU, Products from Attribute, Exclude Categories & Tags, etc.).</li>
										<li><img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">
										Sorting(drag and drop) option for specific products.</li>
										<li><img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">Filter by different product types:(Simple Product, Grouped, External/Affiliate, Variable product).</li>
										<li><img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">
										Special product Category Slider or Grid.</li>
										<li><img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">Display sub or child category slider.</li>
										<li><img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">Show Hidden Products.</li>
										<li><img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">
								...
								<div class="col-lg-6">
									<ul class="upgrade-list">								
										...
										<li><img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">Number of the product(s) to show per page. 20+ Slider Control options.</li>
										<li><img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">
										...
										<li><img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">Fast and Friendly Dedicated Support.</li>
									</ul>
								</div>
							</div>
						</div>
					...
					<div class="container">
						<div class="upgrade-pro">
							<div class="pro-content">
								<div class="pro-icon">
									<img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/256.svg'; ?>" alt="">
								</div>
								<div class="pro-text">
