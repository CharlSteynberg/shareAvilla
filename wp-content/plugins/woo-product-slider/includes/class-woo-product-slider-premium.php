				...
				<div class="row">
					<div class="sp-wps-col-xl-6">
						<div class="sp-wps-banner-content">
							<h2 class="sp-wps-font-30 main-color sp-wps-font-weight-500"><?php _e( 'Upgrade To WooCommerce Product Slider Pro', 'woo-product-slider' ); ?></h2>
							<h4 class="sp-wps-mt-10 sp-wps-font-18 sp-wps-font-weight-500"><?php _e( 'Boost Sales by Beautiful <strong>Interactive Product Sliders!</strong>', 'woo-product-slider' ); ?></h4>
							<p class="sp-wps-mt-25 text-color-2 line-height-20 sp-wps-font-weight-400"><?php _e( 'Show your amazing products to your prospective people in a nice slider or grid to grow your store conversions and sales.', 'woo-product-slider' ); ?></p>
							<p class="sp-wps-mt-20 text-color-2 sp-wps-line-height-20 sp-wps-font-weight-400"><?php _e( 'The perfect way to highlight specific products and, if put in strategic positions, it will help you to increase conversions and purchases in your shop.', 'woo-product-slider' ); ?></p>
						</div>
					...
					<div class="sp-wps-col-xl-6">
						<div class="sp-wps-banner-img">
							<img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/premium/woo-product-sldier-vector.svg'; ?>" alt="">
						</div>
					</div>
				</div>
			</div>
		...
		<section class="sp-wps-video">
			<div class="sp-wps-container">
				...
				<div class="video-area text-center">
					<img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/premium/boost-sales-concept.svg'; ?>" alt="">
					<div class="video-button">
						<a class="js-video-button" href="#" data-channel="youtube" data-video-url="//www.youtube.com/embed/N26gMvfeGiw">
			...
			<div class="sp-wps-container">
				...
				<div class="feature-wrapper">
					<div class="feature-area">
						<div class="feature-item mr-30">
							<div class="feature-icon">
								<img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/premium/layouts.svg'; ?>" alt="">
							</div>
						...
						<div class="feature-item ml-30">
							<div class="feature-icon">
								<img src="
								<?php echo SP_WPS_URL . 'admin/assets/css/images/premium/slider-grid.svg'; ?>
								" alt="">
							</div>
							<div class="feature-content">
					...
					<div class="feature-item mr-30">
							<div class="feature-icon">
								<img src="
								<?php echo SP_WPS_URL . 'admin/assets/css/images/premium/color-styling.svg'; ?>
								" alt="">
							</div>
							<div class="feature-content">
						...
						<div class="feature-item ml-30">
							<div class="feature-icon">
								<img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/premium/Customize-Everything-Easily.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
					...
					<div class="feature-item mr-30">
							<div class="feature-icon">
								<img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/premium/filter.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
						...
						<div class="feature-item ml-30">
							<div class="feature-icon">
								<img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/premium/specific.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
					...
					<div class="feature-item mr-30">
							<div class="feature-icon">
								<img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/premium/cross-sells.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
						...
						<div class="feature-item ml-30">
							<div class="feature-icon">
								<img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/premium/related.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
					...
					<div class="feature-item mr-30">
							<div class="feature-icon">
								<img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/premium/filter-types.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
						...
						<div class="feature-item ml-30">
							<div class="feature-icon">
								<img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/premium/typo.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
					...
					<div class="feature-area">
						<div class="feature-item mr-30">
							<div class="feature-icon">
								<img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/premium/badge.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
						...
						<div class="feature-item ml-30">
							<div class="feature-icon">
								<img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/premium/carousel-control.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
					...
					<div class="feature-area">
						<div class="feature-item mr-30">
							<div class="feature-icon">
								<img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/premium/row.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
						...
						<div class="feature-item ml-30">
							<div class="feature-icon">
								<img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/premium/ajax-p-control.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
					...
					<div class="feature-area">
						<div class="feature-item mr-30">
							<div class="feature-icon">
								<img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/premium/lightbox.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
						...
						<div class="feature-item ml-30">
							<div class="feature-icon">
								<img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/premium/advanced-settings.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
					...
					<div class="feature-area">
						<div class="feature-item mr-30">
							<div class="feature-icon">
								<img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/premium/Translation-RTL-Ready.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
						...
						<div class="feature-item ml-30">
							<div class="feature-icon">
								<img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/premium/frequent.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
		...
		<div class="row">
				<div class="col-lg-6">
					<div class="testimonial-area">
						...
						<div class="testimonial-info">
							<div class="img">
								<img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/Asaf-Moraz-min.jpeg'; ?>" alt="">
							</div>
							<div class="info">
								<h3>Asaf Moraz</h3>
								<div class="star">
				...
				<div class="col-lg-6">
					<div class="testimonial-area">
						...
						<div class="testimonial-info">
							<div class="img">
								<img src="<?php echo SP_WPS_URL . 'admin/assets/css/images/Faruk-Prnjavorac-min.jpeg'; ?>" alt="">
							</div>
							<div class="info">
