 ...
 *
 */
class SP_WQV_Framework_Option_select_typo extends SP_WQV_Framework_Options {
  ...
  public function output() {
    ...
    if( isset( $this->field['options'] ) ) {
      ...
      echo '<select '.$placeholder_data.' name="'. $this->element_name( $extra_name ) .'"'. $this->element_class( $chosen_rtl ). $this->element_attributes() .'>';
