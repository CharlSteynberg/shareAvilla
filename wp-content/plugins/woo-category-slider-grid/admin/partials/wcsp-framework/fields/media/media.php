 ...
 *
 */
if( ! class_exists( 'SP_WCS_Field_media' ) ) {
  class SP_WCS_Field_media extends SP_WCS_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        ...
        'preview'      => true,
        'library'      => array(),
        'button_title' => esc_html__( 'Upload', 'woo-category-slider' ),
        'remove_title' => esc_html__( 'Remove', 'woo-category-slider' ),
      ...
      $placeholder = ( empty( $this->field['placeholder'] ) ) ? ' placeholder="'.  esc_html__( 'No media selected', 'woo-category-slider' ) .'"' : '';
