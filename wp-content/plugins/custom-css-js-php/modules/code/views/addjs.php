...
$form  = new WCJP_FORM();
$form->set_header( __( 'Javascript Code', WCJP_TEXT_DOMAIN ), $response, __( 'Manage JS', WCJP_TEXT_DOMAIN ), 'wcjp_managejs_code' );
...
$form->add_element( 'textarea', 'data_source', array(
		'lable' => __( 'Paste js code here', WCJP_TEXT_DOMAIN ),
