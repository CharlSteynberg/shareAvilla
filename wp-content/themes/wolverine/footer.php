			...
			if (!isset($footer_wrap_layout) || ($footer_wrap_layout === false) || $footer_wrap_layout == '' || $footer_wrap_layout == '-1') {
			...
			$footer_parallax = g5plus_rwmb_meta($prefix . 'footer_parallax');
			...
			$collapse_footer = g5plus_rwmb_meta($prefix . 'collapse_footer');
			...
			$footer_scheme_custom = g5plus_rwmb_meta($prefix . 'footer_scheme');
			$footer_scheme = $footer_scheme_custom;
			if (!isset($footer_scheme) || ($footer_scheme_custom === false) || $footer_scheme == '' || $footer_scheme == '-1') {
			...
			if ($footer_scheme_custom == 'custom') {
				$footer_bg_images = g5plus_rwmb_meta($prefix.'footer_bg_image','type=image&size=full',get_the_ID());
			}
			if (isset($footer_bg_images) && $footer_bg_images) {
				...
				$footer_bg_image = g5plus_get_option('footer_bg_image',array());
			}
            $footer_bg_image_url = '';
			if (is_array($footer_bg_image) && isset($footer_bg_image['url'])) {
			...
			$footer_show_hide = g5plus_rwmb_meta($prefix . 'footer_show_hide');
