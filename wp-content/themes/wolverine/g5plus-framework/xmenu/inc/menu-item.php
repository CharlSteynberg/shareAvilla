	...
	<div class="xmenu-config-panel-wrapper">
		<div class="xmenu-header">
			<h2>
				...
				<button class="x-button xmenu-config-panel-save" type="button"><i class="fa fa-save"></i> <?php echo __('Save Changes','wolverine') ?></button>
		...
		<div class="xmenu-config-panel-left">
			<ul>
				...
				<?php endforeach; ?>
				<li class="x-reset">
					<i class="fa fa-refresh"></i> <?php _e('Reset','wolverine') ?>
				</li>
			</ul>
		</div>
		...
		<div class="xmenu-icon-popup">
			<div class="xmenu-icon-popup-header">
				<input type="text" placeholder="<?php _e('Type to search...','wolverine') ?>"/>
...
function xmenu_save_config_callback() {
	$error_result = array(
		'code' => '-1',
		'message' => __('Save menu config fail','wolverine'),
	);
