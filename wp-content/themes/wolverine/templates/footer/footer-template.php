...
$footer_top_bar_show_hide = g5plus_rwmb_meta($prefix . 'footer_top_bar_show_hide');
...
$footer_wrap_layout = g5plus_rwmb_meta($prefix . 'footer_wrap_layout');
if (!isset($footer_wrap_layout) || $footer_wrap_layout == '' || $footer_wrap_layout == '-1') {
	$footer_wrap_layout = g5plus_get_option('footer_wrap_layout','full');
}


$footer_layout_custom = g5plus_rwmb_meta($prefix . 'footer_layout');
$footer_layout = $footer_layout_custom;
if (!isset($footer_layout) || $footer_layout == '' || $footer_layout == '-1') {
	$footer_layout = g5plus_get_option('footer_layout','footer-5');
}

if (!isset($footer_layout_custom) || $footer_layout_custom == '' || $footer_layout_custom == '-1') {
	$footer_sidebar_1 = g5plus_get_option('footer_sidebar_1','footer-1');
} else {
	$footer_sidebar_1 = g5plus_rwmb_meta($prefix. 'footer_sidebar_1');
}

$footer_sidebar[0] = $footer_sidebar_1;

if (!isset($footer_layout_custom) || $footer_layout_custom == '' || $footer_layout_custom == '-1') {
	$footer_sidebar_2 = g5plus_get_option('footer_sidebar_2','footer-2');
} else {
	$footer_sidebar_2 = g5plus_rwmb_meta($prefix . 'footer_sidebar_2');
}

$footer_sidebar[1] = $footer_sidebar_2;

if (!isset($footer_layout_custom) || $footer_layout_custom == '' || $footer_layout_custom == '-1') {
	$footer_sidebar_3 = g5plus_get_option('footer_sidebar_3','footer-3');
} else {
	$footer_sidebar_3 = g5plus_rwmb_meta($prefix . 'footer_sidebar_3');
}
$footer_sidebar[2] = $footer_sidebar_3;

if (!isset($footer_layout_custom) || $footer_layout_custom == '' || $footer_layout_custom == '-1') {
	$footer_sidebar_4 = g5plus_get_option('footer_sidebar_4','footer-4');
} else {
	$footer_sidebar_4 = g5plus_rwmb_meta($prefix . 'footer_sidebar_4');
}
