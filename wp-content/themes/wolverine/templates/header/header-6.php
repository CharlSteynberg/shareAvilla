...
$header_class = array('main-header', 'header-6');
...
if ($header_sticky == '1') {
	...
	if (($header_sticky_scheme == false) || ($header_sticky_scheme == '') || ($header_sticky_scheme == '-1')) {
...
if (($header_nav_layout == '-1') || ($header_nav_layout === '') || ($header_nav_layout === false)) {
	$header_nav_layout = g5plus_get_option('header_nav_layout');
}
