...
$header_class = array('main-header', 'header-4');
...
$header_tag_line = g5plus_rwmb_meta($prefix . 'header_tag_line');
if ($header_tag_line == '') {
	$header_tag_line = g5plus_get_option('header_tag_line');
}
...
<header id="header" class="<?php echo join(' ', $header_class) ?>">
	...
	<div class="header-nav-bellow">
		...
		<?php if (!empty($header_tag_line)): ?>
			<p class="header-tagline">
				<span><?php echo esc_html($header_tag_line) ?></span>
			</p>
		<?php endif;?>
	</div>
</header>