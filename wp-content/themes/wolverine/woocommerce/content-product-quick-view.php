			...
			<script>
				if (typeof(wc_add_to_cart_variation_params) === 'undefined') {
					var wc_add_to_cart_variation_params = {
						'i18n_no_matching_variations_text' : '<?php echo esc_attr__( 'Sorry, no products matched your selection. Please choose a different combination.', 'wolverine' ); ?>',
						'i18n_make_a_selection_text' : '<?php echo esc_attr__( 'Select product options before adding this product to your cart.', 'wolverine' ); ?>',
						'i18n_unavailable_text' : '<?php echo esc_attr__( 'Sorry, this product is unavailable. Please choose a different combination.', 'wolverine' ); ?>'
					};
				}
			</script>
		<?php endif; ?>
